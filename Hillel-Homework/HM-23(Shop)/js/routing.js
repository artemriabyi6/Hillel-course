...
export let references = {
    ['index.html']: document.getElementById('homepage'),
...
export function checkURL() {
    switch(window.location.pathname) {
        ...
        case '/lego' :    renderProducts('lego')
                          document.getElementById('productsBox').style.flexDirection = 'inherit'
                          break;
        case '/Hillel-Homework/HM-23(Shop)/index.html' : document.getElementById('productsBox').innerHTML = ''
                          break;
...
checkURL()
// references.flowers.addEventListener('click', () => {
